...
%
%
%  Alessandro Foi and Markku M鋕italo - Tampere University of Technology - 2011
% -------------------------------------------------------------------------------
...
if 1
    ...
    fz = 2/alpha * sqrt(double(max(0,alpha*z + (3/8)*alpha^2 + sigma^2 - alpha*g)));%sqrt()输入必须是单精度或双精度,不能是uint8
